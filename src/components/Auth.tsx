    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-[#0f1117] to-[#1a1d26]">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white">SlipSaver</h1>
          <p className="text-gray-400 mt-2">Manage your finances with AI-powered slip processing.</p>
        </div>
                  ...
                  <>
                    ...
                    <div className="relative py-4">
                      ...
                      <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-[#1a1d26] px-2 text-gray-500">Or continue with</span>
                      </div>
                    </div>
          ...
          <TabsContent value="signup">
            <Card className="bg-[#1a1d26] border-[#2d313d] text-white">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">Join SlipSaver and start managing your slips.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
